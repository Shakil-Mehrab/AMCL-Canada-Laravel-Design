...
Vue.component('addtask', require('./addModalComponent.vue').default);//modal
    ...
    <div class="container">
        <div class="list-group">
          <a href="#" class="list-group-item active">
            <h4>All Todo Tasks<span class="pull-right"><button class="btn btn-success btn-xs">+</button></span></h4>
          </a>
          <a href="#" class="list-group-item" v-for="t in tasks">{{t.id}}-{{t.name}}
          	<span class="pull-right"><button class="btn btn-primary btn-xs">Edit</button>|<button class="btn btn-danger btn-xs">Delete</button>|<button class="btn btn-info btn-xs">Preview</button></span></a>
 ...
 public function index()
    ...
    <div class="container">
        <div class="list-group">
          ...
          <a href="#" class="list-group-item" v-for="t in tasks.data">{{t.id}}-{{t.name}}
          	<span class="pull-right"><button class="btn btn-primary btn-xs">Edit</button>|<button class="btn btn-danger btn-xs">Delete</button>|<button class="btn btn-info btn-xs">Preview</button></span></a>
          	<pagination :data="tasks" v-on:pagination-change-page="getResults"></pagination>
        </div>
    </div>
